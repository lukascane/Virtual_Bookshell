  ...
  const switchAvatar = () => {
    let defaultElement = (
      <img
        ...
        title="Click here to select a new avatar."
      />
    );
  ...
  return (
    <div id="profile">
      ...
      <div className="d-flex justify-content-between align-items-center mx-5 subC">
        ...
        >
          <a
            onClick={() => props.setShowComponent(true)}
      ...
      <div className="d-flex flex-column align-items-center">
        <button
          className="rounded-pill buttons mt-5 mb-2"
          type="button"
          onClick={() => onClickShowAlert(4)}
        >
          SAVE AVATAR
        </button>
        <button
          className="rounded-pill buttons mt-3 mb-2"
          type="button"
          onClick={() => onClickShowAlert2(13)}
        >
          DELETE USER
        </button>
      </div>
