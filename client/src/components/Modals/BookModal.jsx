...
export default function BookModal() {
  ...
  <div id='bookModalContainer' className='mb-5'>
     ...
     <div id='bookModal' className='justify-content-between align-items-center'>
        ...
        <a href="#" className="btn btLink m-2">Read/to read</a>
        </div>
        ...
        <div className='textContainer'>
            ...
            <div data-bs-spy="scroll" data-bs-target="#list-example" data-bs-offset="0" className="rounded scrollspy-example mt-3 textScroll p-3 mb-5" tabindex="0">
