...
module.exports.validateUser = [
    ...
    .exists()
    .trim()
    .isAlphanumeric('fr-FR','de-DE','en-US').withMessage('firstname should be alphanumeric')
    ...
    .exists()
    .trim()
    .isAlphanumeric('fr-FR','de-DE', 'en-US').withMessage('lastname should be alphanumeric')
